...
exports.handle_mod_list=(req,res) ->
  res.writeHead 200,'application/json'
  res.end JSON.stringify conf.client_modules

exports.handle_module=(req,res,modname,modversion) ->
  #TODO: currently, we ignore modversion and always fetch the current version
